document.addEventListener('DOMContentLoaded', () => {
    ...
    navLinks.forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            if (targetId.startsWith('#')) {
                ...
                if (targetElement) {
                    // ✅ FIX: Removed hardcoded -20 offset to prevent content overlap
    ...
    // Intersection Observer for highlighting active section in navbar
    // ✅ FIX: Adjusted rootMargin to compensate for the sticky navbar height (approx. 80px)
    const observerOptions = {
        root: null, 
        rootMargin: '-80px 0px 0px 0px', // Corrected margin for sticky header
        threshold: 0
    };
